...
public class EventConstants {
    ...
    public static final LocalDto LOCAL_DTO = new LocalDto(STREET_EVENT1, DISTRICT_EVENT1, NUMBER_EVENT1, CITY_EVENT1, COUNTRY_EVENT1);
    ...
    public static final LocalDto LOCAL_DTO2 = new LocalDto(STREET_EVENT2, DISTRICT_EVENT2, NUMBER_EVENT2, CITY_EVENT2, COUNTRY_EVENT2);
    ...
    public static final LocalDto UNUSED_LOCAL = new LocalDto(UNUSED_STREET_EVENT, UNUSED_DISTRICT_EVENT, UNUSED_NUMBER_EVENT, UNUSED_CITY_EVENT, UNUSED_COUNTRY_EVENT);
