...
public class UserConstants {
    ...
    public static final RegisterDTO primeiroRegistroDto = new RegisterDTO(USER1_EMAIL, USER1_USERNAME, USER1_PASSWORD, UserRole.ADMIN);
    public static final AuthDTO primeiroAuthDto = new AuthDTO(USER1_EMAIL, USER1_PASSWORD);

    public static final RegisterDTO segundoRegistroDto = new RegisterDTO(USER2_EMAIL, USER2_USERNAME, USER2_PASSWORD, UserRole.ADMIN);
