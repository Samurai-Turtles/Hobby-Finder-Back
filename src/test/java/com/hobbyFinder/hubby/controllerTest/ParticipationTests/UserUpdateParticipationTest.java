...
public class UserUpdateParticipationTest {
    ...
    void updateUserParticipationSucess() throws Exception {
        ...
        driver.perform(put(ParticipationRoutes.USER_UPDATE_PARTICIPATION, idEvent, idNewParticipation)
                        .contentType(MediaType.APPLICATION_JSON)
    ...
    void updateUserEventNotFound() throws Exception {
        ...
        String responseJsonString = driver.perform(put(ParticipationRoutes.USER_UPDATE_PARTICIPATION, idEvent, idNewParticipation)
                        .contentType(MediaType.APPLICATION_JSON)
                        .header("Authorization", "Bearer " + token)
                        .param("userParticipation", userParticipation.name()))
